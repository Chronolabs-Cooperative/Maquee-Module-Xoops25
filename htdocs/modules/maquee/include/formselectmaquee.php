 ...
 * @access 		public
 */
class MaqueeFormSelectMaquee extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function MaqueeFormSelectMaquee($caption, $name, $value = null, $size = 1, $multiple = false, $none = false, $types = '_MI_MAQUEE_TYPE_GALLERY,_MI_MAQUEE_TYPE_TICKER')
    {
		...
		foreach($maquee_handler->getObjects(new Criteria('type', '("'.implode('","', explode(',',$types)).'")', 'IN'), true) as $mid => $obj)
