 ...
 * @version         $Id: formselecttype.php 8100 2011-11-06 10:16:18Z beckmi $
 */
 ...
 * @access 		public
 */
class MaqueeFormSelectType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function MaqueeFormSelectType($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_MAQUEE_TYPE_GALLERY','_MI_MAQUEE_TYPE_TICKER') as $mode)
