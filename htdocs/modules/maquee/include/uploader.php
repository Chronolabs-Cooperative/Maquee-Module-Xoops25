...
class MaqueeXoopsMediaUploader
{
	var $mediaName;
	var $mediaType;
	var $mediaSize;
	 ...
	 **/
	function MaqueeXoopsMediaUploader($uploadDir, $allowedMimeTypes, $maxFileSize, $maxWidth=null, $maxHeight=null, $allowedExtensions=null )
	{
