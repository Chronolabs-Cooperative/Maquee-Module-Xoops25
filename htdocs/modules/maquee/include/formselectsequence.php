 ...
 * @version         $Id: formselectsequence.php 8100 2011-11-06 10:16:18Z beckmi $
 */
 ...
 * @access 		public
 */
class MaqueeFormSelectSequence extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function MaqueeFormSelectSequence($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_MAQUEE_SEQUENCE_SEQUENCE','_MI_MAQUEE_SEQUENCE_RANDOM','_MI_MAQUEE_SEQUENCE_RANDOM_START','_MI_MAQUEE_SEQUENCE_DEFAULT') as $mode)
