 ...
 * @access 		public
 */
class MaqueeFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function MaqueeFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'maquee');
